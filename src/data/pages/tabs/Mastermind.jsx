const tabs = [
  {
    ...
    content: (
      <ol>
        ...
        <li>
          Each turn, place your guess by arranging colored pegs in the row. You
          can repeat colors, unless the rules say otherwise.
        </li>
        <li>
          After submitting your guess, look out for clue pegs:{' '}
          <strong>Black</strong> means a correct color in the correct position,
          and <strong>White</strong> means a correct color in the wrong
          position.
        </li>
        <li>
        ...
        <li>
          You’ve got a limited number of turns (usually 10 or 12), so make each
          guess count.
        </li>
        <li>
          Once the code is cracked or turns run out, reveal the hidden code,
          swap roles, and try again for a rematch!
        </li>
      </ol>
    ),
  },
