    ...
    <footer className='ft-footer'>
      <div className='grid ft-footer-wrapper'>
        <div className='ft-content-wrapper'>
          <p className='ft-heading'>
            Hello, I&apos;m <span className='ft-underline'>John Ruane</span>.
          </p>
          ...
          <p className='ft-text'>
            ...
            it be great if I could share these in a way that was useful for other
            developers as a fun way to learn”. That&apos;s when React Gameplay was
            conceived; showcasing React&apos;s capabilities and serving as a learning
